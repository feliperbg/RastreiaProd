# Sistema de Controles de Etapas do Processo de Produção e Rastreabilidade de Componentes
...
## Bibliotecas
- **npm install bcrypt ejs express jsonwebtoken mongodb mongoose mongoose-sequence axios fs nodemailer multer**
